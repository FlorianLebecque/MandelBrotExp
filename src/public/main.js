...
const API_URL = "api." + window.location.hostname;
...
function btnClick() {
    ...
    fetch('https://' + API_URL + '/Mandelbrot?from=' + from_v + '&to=' + to_v + '&step=' + step_v + '&iter=' + iter_v + '&split=' + split_v, opts)
...
function GetyImg() {
    const imageUrl = 'https://' + API_URL + '/Mandelbrot?from=' + from_v + '&to=' + to_v + '&step=' + step_v + '&iter=' + iter_v;
